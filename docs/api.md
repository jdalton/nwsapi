...
| Method | Result |
| --- | --- |
| [`byClass(cls, context)`](../src/nwsapi.mts#L2997) | Returns elements with the class name. |
| [`byId(id, context)`](../src/nwsapi.mts#L2995) | Returns elements with the ID. Duplicate IDs are allowed by default. |
| [`byTag(tag, context)`](../src/nwsapi.mts#L2996) | Returns elements with the tag name. Use `*` for all elements. |
| [`closest(selectors, element, callback)`](../src/nwsapi.mts#L3003) | Returns the nearest match, starting with the element, or `null`. |
| [`compile(selector, mode, callback)`](../src/nwsapi.mts#L3005) | Compiles a selector into a resolver function. This is an advanced API. |
| [`configure(option, clear)`](../src/nwsapi.mts#L3006) | Reads or changes options. Pass `true` as the second argument to clear compiled selectors. |
| [`emit(message, proto)`](../src/nwsapi.mts#L3008) | Reports an error using the configured error policy. |
| [`first(selectors, context, callback)`](../src/nwsapi.mts#L2999) | Returns the first matching descendant, or `null`. |
| [`install(all)`](../src/nwsapi.mts#L3014) | Replaces native selector methods. Pass `true` to also replace collection methods. |
| [`match(selectors, element, callback)`](../src/nwsapi.mts#L3000) | Returns whether the element matches. |
| [`registerCombinator(combinator, resolver)`](../src/nwsapi.mts#L3021) | Adds a relationship between elements using trusted resolver code. |
| [`registerOperator(operator, resolver)`](../src/nwsapi.mts#L3046) | Adds an attribute operator using a resolver with `p1`, `p2`, and `p3` fields. |
| [`registerSelector(name, rexp, func)`](../src/nwsapi.mts#L3068) | Adds a selector pattern and a compiler callback that returns `source` and `status`. |
| [`select(selectors, context, callback)`](../src/nwsapi.mts#L3001) | Returns an array of matching descendants, or an empty array. |
| [`uninstall()`](../src/nwsapi.mts#L3015) | Restores the native methods saved by `install()`. |
...
| Member | Purpose |
| --- | --- |
| [`CFG`](../src/nwsapi.mts#L2983) | Contains the compiler syntax settings. |
| [`Config`](../src/nwsapi.mts#L3009) | Contains the active options. Use `configure()` to change them. |
| [`M_BODY`](../src/nwsapi.mts#L2986) | Contains the matching resolver body template. |
| [`M_TEST`](../src/nwsapi.mts#L2990) | Contains the matching resolver test template. |
| [`matchLambdas`](../src/nwsapi.mts#L2975) | Caches compiled matching functions, not DOM results. |
| [`matchResolvers`](../src/nwsapi.mts#L2978) | Caches matching plans, not DOM results. |
| [`N_BODY`](../src/nwsapi.mts#L2987) | Exposes the matching resolver body template. |
| [`N_TEST`](../src/nwsapi.mts#L2991) | Contains the alternate resolver test template. |
| [`Operators`](../src/nwsapi.mts#L3017) | Contains registered attribute operators. |
| [`S_BODY`](../src/nwsapi.mts#L2985) | Contains the selection resolver body template. |
| [`S_TEST`](../src/nwsapi.mts#L2989) | Contains the selection resolver test template. |
| [`selectLambdas`](../src/nwsapi.mts#L2976) | Caches compiled selection functions, not DOM results. |
| [`Selectors`](../src/nwsapi.mts#L3018) | Contains registered selector extensions. |
| [`selectResolvers`](../src/nwsapi.mts#L2979) | Caches selection plans, not DOM results. |
| [`Snapshot`](../src/nwsapi.mts#L3010) | Contains the document state and helpers used by compiled selectors. |
| [`Version`](../src/nwsapi.mts#L3012) | Contains the engine version string. |
