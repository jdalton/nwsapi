...
| Method | Result |
| --- | --- |
| [`byClass(cls, context)`](../src/nwsapi.mts#L2981) | Returns elements with the class name. |
| [`byId(id, context)`](../src/nwsapi.mts#L2979) | Returns elements with the ID. Duplicate IDs are allowed by default. |
| [`byTag(tag, context)`](../src/nwsapi.mts#L2980) | Returns elements with the tag name. Use `*` for all elements. |
| [`closest(selectors, element, callback)`](../src/nwsapi.mts#L2987) | Returns the nearest match, starting with the element, or `null`. |
| [`compile(selector, mode, callback)`](../src/nwsapi.mts#L2989) | Compiles a selector into a resolver function. This is an advanced API. |
| [`configure(option, clear)`](../src/nwsapi.mts#L2990) | Reads or changes options. Pass `true` as the second argument to clear compiled selectors. |
| [`emit(message, proto)`](../src/nwsapi.mts#L2992) | Reports an error using the configured error policy. |
| [`first(selectors, context, callback)`](../src/nwsapi.mts#L2983) | Returns the first matching descendant, or `null`. |
| [`install(all)`](../src/nwsapi.mts#L2998) | Replaces native selector methods. Pass `true` to also replace collection methods. |
| [`match(selectors, element, callback)`](../src/nwsapi.mts#L2984) | Returns whether the element matches. |
| [`registerCombinator(combinator, resolver)`](../src/nwsapi.mts#L3005) | Adds a relationship between elements using trusted resolver code. |
| [`registerOperator(operator, resolver)`](../src/nwsapi.mts#L3030) | Adds an attribute operator using a resolver with `p1`, `p2`, and `p3` fields. |
| [`registerSelector(name, rexp, func)`](../src/nwsapi.mts#L3052) | Adds a selector pattern and a compiler callback that returns `source` and `status`. |
| [`select(selectors, context, callback)`](../src/nwsapi.mts#L2985) | Returns an array of matching descendants, or an empty array. |
| [`uninstall()`](../src/nwsapi.mts#L2999) | Restores the native methods saved by `install()`. |
...
| Member | Purpose |
| --- | --- |
| [`CFG`](../src/nwsapi.mts#L2967) | Contains the compiler syntax settings. |
| [`Config`](../src/nwsapi.mts#L2993) | Contains the active options. Use `configure()` to change them. |
| [`M_BODY`](../src/nwsapi.mts#L2970) | Contains the matching resolver body template. |
| [`M_TEST`](../src/nwsapi.mts#L2974) | Contains the matching resolver test template. |
| [`matchLambdas`](../src/nwsapi.mts#L2959) | Caches compiled matching functions, not DOM results. |
| [`matchResolvers`](../src/nwsapi.mts#L2962) | Caches matching plans, not DOM results. |
| [`N_BODY`](../src/nwsapi.mts#L2971) | Exposes the matching resolver body template. |
| [`N_TEST`](../src/nwsapi.mts#L2975) | Contains the alternate resolver test template. |
| [`Operators`](../src/nwsapi.mts#L3001) | Contains registered attribute operators. |
| [`S_BODY`](../src/nwsapi.mts#L2969) | Contains the selection resolver body template. |
| [`S_TEST`](../src/nwsapi.mts#L2973) | Contains the selection resolver test template. |
| [`selectLambdas`](../src/nwsapi.mts#L2960) | Caches compiled selection functions, not DOM results. |
| [`Selectors`](../src/nwsapi.mts#L3002) | Contains registered selector extensions. |
| [`selectResolvers`](../src/nwsapi.mts#L2963) | Caches selection plans, not DOM results. |
| [`Snapshot`](../src/nwsapi.mts#L2994) | Contains the document state and helpers used by compiled selectors. |
| [`Version`](../src/nwsapi.mts#L2996) | Contains the engine version string. |
